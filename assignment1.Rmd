...
wget https://www.dropbox.com/s/cw0rtq60a2o2kub/data_brainspan_DFC.20190924.Rdata

# After download, please load data by `load('data_brainspan_DFC.20190924.Rdata')`.
```
